...
/**
 * SVG data URI patterns for use with ParallaxBg.
 * Each tile is designed to look non-geometric so parallax drift is readable.
 * Tune individual fill-opacity / stroke-opacity values to taste.
 */
